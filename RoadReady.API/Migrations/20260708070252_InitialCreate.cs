        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceReports_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceReports_Users_ReportedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CheckInId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReservationId = table.Column<int>(type: "int", nullable: false),
                    RentalAgentId = table.Column<int>(type: "int", nullable: false),
                    ...
                    FuelLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    KeyHandedOver = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckIns_Users_RentalAgentId",
                        column: x => x.RentalAgentId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckOuts_Users_RentalAgentId",
                        column: x => x.RentalAgentId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ReservationId = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 10, scale: 2, nullable: false),
                    ...
                    RazorpaySignature = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckIns_RentalAgentId",
                table: "CheckIns",
                column: "RentalAgentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckOuts_RentalAgentId",
                table: "CheckOuts",
                column: "RentalAgentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceReports_CarId",
                table: "MaintenanceReports",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceReports_ReportedBy",
                table: "MaintenanceReports",
                column: "ReportedBy");
